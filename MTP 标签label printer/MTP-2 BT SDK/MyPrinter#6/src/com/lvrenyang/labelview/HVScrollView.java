...
public class HVScrollView extends FrameLayout {
	...
	private OnScrollChangedListener mScrollChanged = null;
	...
	public void setOnScrollChangedListener(
		...
		mScrollChanged = onScrollChangedListener;
	}
	...
	public void scrollTo(int x, int y) {
		...
		if (getChildCount() > 0) {
			...
			if (x != oldx || y != oldy) {
				super.scrollTo(x, y);
				if (null != mScrollChanged)
					mScrollChanged.onScrollChanged(x, y, oldx, oldy);
			}
		}
	}
